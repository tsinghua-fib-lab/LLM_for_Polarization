...
- `data/figure2c_self_inconsistency.csv`: self-inconsistency rates for the three main topics under original and self-regulated conditions.
...
- Figure 2c values use the same self-inconsistency calculation as the `# figure 2c` section in `fig2/fig2.ipynb`.
